...
public class AngularAndWebDriverTest {
  ...
  public void before_suite() throws Exception {
    ...
    // Launch Protractor's own test app on http://localhost:9000
...
//
//    driver.get("http://localhost:9000/#/form");
//    ngWebDriver.waitForAngularRequestsToFinish();
//
...
//      resetBrowser();
//
//      driver.get("http://localhost:9000/index.html#/form");
...
//    FluentWebDriver fwd = new FluentWebDriver(driver);
//    driver.get("http://localhost:9000/alt_root_index.html#/form");
//    ngWebDriver.waitForAngularRequestsToFinish();
//
//
...
//    FluentWebDriver fwd = new FluentWebDriver(driver);
//
//    driver.get("http://localhost:9000/index.html#/conflict");
//
...
//    FluentWebDriver fwd = new FluentWebDriver(driver);
//
//    driver.get("http://localhost:9000/index.html#/repeater");
//
